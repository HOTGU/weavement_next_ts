...
const Modal: React.FC<ModalProps> = ({
  ...
  return (
    <div
      className="flex items-center justify-center overflow-x-hidden overflow-y-hidden fixed inset-0 z-50 outline-none bg-neutral-800/70"
      onClick={handleClose}
    >
      <div
        className="relative w-full md:w-4/6 lg:w-1/2 xl:w-2/5 my-6 mx-auto h-full md:h-auto"
