  ...
  return (
    <div className="w-full relative">
      <input
        ...
        placeholder=" "
        type={type}
        className={`peer w-full p-4 z-10 bg-white font-light border focus:border-2 rounded-md outline-none transition disabled:bg-neutral-50 disabled:cursor-not-allowed pl-4 ${
          errors[name]
