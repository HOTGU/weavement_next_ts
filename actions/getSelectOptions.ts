...
export default () => {
  ...
  const contactPathOptions: OptionType[] = [
    ...
    { value: "대표(전화)", label: "대표(전화)" },
    { value: "대표(문자)", label: "대표(문자)" },
    { value: "대표(카톡)", label: "대표(카톡)" },
    { value: "블로그1(전화)", label: "블로그1(전화)" },
    { value: "블로그1(문자)", label: "블로그1(문자)" },
    { value: "블로그1(카톡)", label: "블로그1(카톡)" },
    { value: "블로그2(전화)", label: "블로그2(전화)" },
    { value: "블로그2(문자)", label: "블로그2(문자)" },
    { value: "블로그2(카톡)", label: "블로그2(카톡)" },
    { value: "블로그3(전화)", label: "블로그3(전화)" },
    { value: "블로그3(문자)", label: "블로그3(문자)" },
    { value: "블로그3(카톡)", label: "블로그3(카톡)" },
